...
export const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="min-h-screen py-20 sm:py-32 relative">
      <div className="container mx-auto px-4 sm:px-6">
        <motion.div ref={ref} className="max-w-6xl mx-auto">
          ...
          >
            Equipped with essential skills and tools for comprehensive game
            quality assurance. Each skill node represents mastery in critical
            testing domains.
          </motion.p>
          ...
          >
            <h4 className="text-[10px] sm:text-xs text-muted-foreground font-mono mb-3 sm:mb-4 tracking-wider">
