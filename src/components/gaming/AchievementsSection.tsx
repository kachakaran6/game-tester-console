    ...
    <section id="achievements" className="py-32 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            Professional certifications and educational milestones unlocked throughout 
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {achievements.map((achievement, index) => {
              ...
              return (
                <motion.div
                  key={achievement.id}
                  className={`relative p-6 rounded-2xl bg-gradient-to-br ${rarityColors[rarity]} border overflow-hidden group cursor-pointer`}
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.5 + index * 0.2 + 0.3, duration: 0.5 }}
                  />
                  ...
                  {/* Rarity Badge */}
                  <div className={`absolute top-4 right-4 px-2 py-1 rounded text-xs font-mono ${rarityTextColors[rarity]} bg-background/50`}>
                    {achievement.rarity}
                  </div>

                  {/* Icon */}
                  <motion.div
                    className={`w-20 h-20 rounded-2xl ${rarityTextColors[rarity]} bg-background/30 flex items-center justify-center mb-4`}
                    animate={{ 
                      rotate: [0, 5, -5, 0],
                    }}
                    transition={{ 
