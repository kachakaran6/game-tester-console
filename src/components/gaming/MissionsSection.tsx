...
export const MissionsSection = () => {
  ...
  return (
    <section id="missions" className="min-h-screen py-32 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            Field operations conducted across major gaming titles. Each mission represents 
            comprehensive testing campaigns with documented findings and improvements.
          </motion.p>
